...
export const SubCategoryDetails = ({ subCategory, categories, updateSubCategory, onDirtyChange }: SubCategoryDetailsProps) => {
    ...
    const handleFieldUpdate = (field: keyof SubCategoryType, value: any) => {
        setEditValue(value);
                    ...
                    <div className="group relative">
                        ...
                        {editingField === 'categoryId' ? (
                            <Dropdown
                                ...
                                value={String(localData.categoryId || '')}
                            ...
                            >
                                <span className="text-[13px] font-semibold text-gray-900 dark:text-gray-100">
                                    {categories?.find((c: any) => c.id === localData.categoryId)?.name || <span className="text-slate-400 italic font-normal text-[12px]">Not specified</span>}
                                </span>
